...
"""
class User(object):
  """Information on a recent USB device usage on the image"""

  username = "None provided"
  account_type = "None provided"
  account_created_date = "None provided"
  account_created_time = "None provided"
  last_login_date = "None provided"
  last_login_time = "None provided"