...
class Timestamp(object):
  """Generic file timestamp gathering"""

  atime_date = "None provided"
  atime_time = "None provided"
  mtime_date = "None provided"
  mtime_time = "None provided"
  ctime_date = "None provided"
  ctime_time = "None provided"